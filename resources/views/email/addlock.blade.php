                                            ...
                                            <tr>
                                                <td align='center' valign='top' style='padding:0;Margin:0;width:560px'>
                                                    <table cellpadding='0' cellspacing='0' width='100%' role='presentation' style='mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px'>
                                                        ...
                                                        <tr>
                                                            <td align='center' style='padding:0;Margin:0;padding-bottom:10px'><h1 style='Margin:0;line-height:46px;mso-line-height-rule:exactly;font-family:arial, helvetica neue, helvetica, sans-serif;font-size:46px;font-style:normal;font-weight:bold;color:#333333'>Add-Lock</h1></td>
                                                        </tr>
                                                    </table></td>
                                            </tr>
                                        </table></td>
                                            ...
                                            <tr>
                                                <td class='es-m-p0r' align='center' style='padding:0;Margin:0;width:560px'>
                                                    <table cellpadding='0' cellspacing='0' width='100%' style='mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;border-top:2px solid #efefef;border-bottom:2px solid #efefef' role='presentation'>
                                                        <tr>
                                                            <td align='right' class='es-m-txt-r' style='padding:0;Margin:0;padding-top:10px;padding-bottom:20px'><p style='Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, helvetica neue, helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px'>Amount Fund:&nbsp;<strong>₦{{number_format(intval($input['amount'] *1),2)}}</strong><br>Early Amount:&nbsp;<strong>₦{{number_format(intval($input['before'] *1),2)}}</strong><br>Present Balance:&nbsp;<strong>₦{{number_format(intval($input['balance'] *1),2)}}</strong></p></td>
                                                        </tr>
                                                    </table></td>
                                            </tr>
                                        </table></td>
